...
import { Plus, Calendar, Users, TrendingUp, FileText, Receipt } from 'lucide-react'
        ...
        <section className="mb-6">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-display font-semibold text-text text-sm">Devis</p>
                <p className="text-text-muted text-xs">Composer et envoyer des devis multi-prestataires</p>
              </div>
            </div>
            <span className="text-primary text-sm font-semibold shrink-0">Voir →</span>
          </Link>
